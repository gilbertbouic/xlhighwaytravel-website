...
Every **Tuesday at 11:00 South Africa time**, a GitHub Action copies current XL Travel HQ specials onto `specials.html` as deal cards. Campaigns already written up on the page (Cape Town, Jumeirah, Virgin, Hurtigruten, tours, Avis, Castleburn, One&Only, DSC Transfers, Bakubung / Kwa Maritane) are skipped. The Airlink Lanseria–Harare section is ours and is never replaced.
